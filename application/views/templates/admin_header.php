			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?= $base_url ?>configuration"><i class="icon-home"></i><span class="hidden-tablet"> Configuración</span></a></li>
						<li class="nav-header hidden-tablet"></li>
						<li><a class="ajax-link" href="<?= $base_url ?>categories"><i class="icon-home"></i><span class="hidden-tablet"> Categorías</span></a></li>
						<li><a class="ajax-link" href="<?= $base_url ?>backgrounds"><i class="icon-home"></i><span class="hidden-tablet"> Fondos</span></a></li>
						<li><a class="ajax-link" href="<?= $base_url ?>fonts"><i class="icon-home"></i><span class="hidden-tablet"> Tipografías</span></a></li>
						<li><a class="ajax-link" href="<?= $base_url ?>tags"><i class="icon-home"></i><span class="hidden-tablet"> Etiquetas</span></a></li>
						<li class="nav-header hidden-tablet"></li>
						<li><a class="ajax-link" href="<?= $base_url ?>phrases"><i class="icon-home"></i><span class="hidden-tablet"> Frases</span></a></li>
						<li class="nav-header hidden-tablet"></li>
						<li><a class="ajax-link" href="<?= $base_url ?>pages"><i class="icon-home"></i><span class="hidden-tablet"> Páginas</span></a></li>
						<li class="nav-header hidden-tablet"></li>
						<li><a class="ajax-link" href="<?= $base_url ?>users"><i class="icon-home"></i><span class="hidden-tablet"> Usuarios</span></a></li>
					</ul>
				</div><!--/.well -->
			</div><!--/span-->
			<!-- left menu ends -->
